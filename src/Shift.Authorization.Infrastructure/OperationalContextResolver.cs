...
{
    private const string OperationTenantIdHeader = "X-Operation-Tenant-Id";
    private const string OperationClientIdHeader = "X-Operation-Client-Id";
    ...
    public OperationalContext ResolveContext(HttpContext httpContext, IAuthorizationContext authContext)
    {
        ...
        // Extract headers
        var targetTenantId = ExtractHeader(httpContext, OperationTenantIdHeader);
        var targetClientId = ExtractHeader(httpContext, OperationClientIdHeader);
